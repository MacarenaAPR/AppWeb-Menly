...
def metricas_pedidos_combinadas(restaurante, hoy=None):
    ...
    pedidos_activos = whatsapp["pedidos_activos"] + especiales["pedidos_activos"]
    venta_real_mes = whatsapp["venta_real_mes"] + especiales["venta_real_mes"]
    ticket_promedio_mes = (
    ...
    return {
        "ventas": {
            "venta_real_hoy": whatsapp["venta_real_hoy"] + especiales["venta_real_hoy"],
            "venta_real_semana": (
